...
namespace JavScraper.Scrapers
{
    ...
    /// </summary>
    public class R18Scraper : BaseScraper
    {
        /// <summary>
        /// 适配器名称。
        /// </summary>
        ...
        /// <summary>
        /// 初始化 <seealso cref="R18Scraper"/> 类的新实例。
        /// </summary>
        /// <param name="logManager"><seealso cref="ILoggerFactory"/> 对象实例。</param>
        public R18Scraper(ILoggerFactory logManager)
            : base("https://www.r18.com/", logManager.CreateLogger<R18Scraper>())
        {
        }
