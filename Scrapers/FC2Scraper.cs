...
namespace JavScraper.Scrapers
{
    ...
    /// </summary>
    public class FC2Scraper : BaseScraper
    {
        /// <summary>
        /// 适配器名称。
        /// </summary>
        ...
        /// <summary>
        /// 初始化 <seealso cref="FC2Scraper"/> 类的新实例。
        /// </summary>
        /// <param name="logManager"><seealso cref="ILoggerFactory"/> 对象实例。</param>
        public FC2Scraper(ILoggerFactory logManager)
            : base("https://fc2club.com/", logManager.CreateLogger<FC2Scraper>())
        {
        }
        ...
        public override Task<List<JavVideoIndex>> Query(string key)
        {
            ...
            return Search(new List<JavVideoIndex>(), id);
        }
