...
namespace JavScraper.Scrapers
{
    ...
    /// </summary>
    public class MgsTageScraper : BaseScraper
    {
        /// <summary>
        /// 适配器名称。
        /// </summary>
        ...
        /// <summary>
        /// 初始化 <seealso cref="MgsTageScraper"/> 类的新实例。
        /// </summary>
        /// <param name="logManager"><seealso cref="ILoggerFactory"/> 对象实例。</param>
        public MgsTageScraper(ILoggerFactory logManager)
            : base("https://www.mgstage.com/", logManager.CreateLogger<MgsTageScraper>())
        {
        }
