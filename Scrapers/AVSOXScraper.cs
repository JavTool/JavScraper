...
namespace JavScraper.Scrapers
{
    ...
    /// </summary>
    public class AVSOXScraper : BaseScraper
    {
        /// <summary>
        /// 适配器名称
        /// </summary>
        ...
        /// <summary>
        /// 初始化 <seealso cref="AVSOXScraper"/> 类的新实例。
        /// </summary>
        /// <param name="logManager"><seealso cref="ILoggerFactory"/> 对象实例。</param>
        public AVSOXScraper(ILoggerFactory logManager)
            : base("https://avsox.website/", logManager.CreateLogger<AVSOXScraper>())
        {
        }
