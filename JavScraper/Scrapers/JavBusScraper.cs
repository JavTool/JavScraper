...
namespace JavScraper.Scrapers
{
    ...
    public class JavBusScraper : AbstractScraper
    {
        ...
        /// <summary>
        /// 初始化 <seealso cref="JavBusScraper"/> 类的新实例。
        /// </summary>
        /// <param name="logManager"><seealso cref="ILoggerFactory"/> 对象实例。</param>
        public JavBusScraper(ILoggerFactory logManager) :
            base("https://www.javbus.com/", logManager.CreateLogger<JavBusScraper>())
        {
        }
        ...
        //protected override Task<List<JavVideoIndex>> DoQyery(List<JavVideoIndex> ls, string key)
        //{
