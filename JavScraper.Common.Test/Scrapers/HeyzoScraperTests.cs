...
namespace JavScraper.Common.Test.Scrapers
{
    ...
    /// HeyzoScraper 单元测试类
    /// </summary>
    public class HeyzoScraperTests : TestBase
    {
        private readonly ITestOutputHelper _output;
        private readonly HeyzoScraper _scraper;

        public HeyzoScraperTests(ITestOutputHelper output)
        {
            _output = output;
            _scraper = (HeyzoScraper)CreateScraper("heyzo");
        }

        [Fact]
        public void Name_Should_BeHeyzo()
        {
            Assert.Equal("heyzo", _scraper.Name, ignoreCase: true);
        }
        ...
        public void DefaultBaseUrl_Should_NotBeEmpty()
        {
            ...
            Assert.Contains("heyzo", _scraper.DefaultBaseUrl, StringComparison.OrdinalIgnoreCase);
        }
        ...
        {
            var code = "HEYZO-3196"; // HEYZO 特有格式
        ...
        {
            var video = await _scraper.ScrapeAsync("HEYZO-99999");
