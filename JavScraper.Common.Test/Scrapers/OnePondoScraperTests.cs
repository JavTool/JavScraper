...
{
    /// <summary>
    /// OnePondoScraper 单元测试类
    /// </summary>
    public class OnePondoScraperTests : TestBase
    {
        private readonly ITestOutputHelper _output;
        private readonly OnePondoScraper _scraper;

        public OnePondoScraperTests(ITestOutputHelper output)
        {
            _output = output;
            _scraper = (OnePondoScraper)CreateScraper("1pondo");
        }

        [Fact]
        public void Name_Should_BeOnePondo()
        {
            Assert.Equal("1pondo", _scraper.Name, ignoreCase: true);
        }
        ...
        public void DefaultBaseUrl_Should_NotBeEmpty()
        {
            ...
            Assert.Contains("1pondo", _scraper.DefaultBaseUrl, StringComparison.OrdinalIgnoreCase);
        }
        ...
        {
            var code = "042922_001"; // 1Pondo 特有格式
