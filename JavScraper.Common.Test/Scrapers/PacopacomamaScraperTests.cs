...
{
    /// <summary>
    /// PacopacomamaScraper 单元测试类
    /// </summary>
    public class PacopacomamaScraperTests : TestBase
    {
        private readonly ITestOutputHelper _output;
        private readonly PacopacomamaScraper _scraper;

        public PacopacomamaScraperTests(ITestOutputHelper output)
        {
            _output = output;
            _scraper = (PacopacomamaScraper)CreateScraper("pacopacomama");
        }

        [Fact]
        public void Name_Should_BePacopacomama()
        {
            Assert.Equal("pacopacomama", _scraper.Name, ignoreCase: true);
        }
        ...
        public void DefaultBaseUrl_Should_NotBeEmpty()
        {
            ...
            Assert.Contains("pacopacomama", _scraper.DefaultBaseUrl, StringComparison.OrdinalIgnoreCase);
        }
        ...
        {
            var code = "042922_001"; // Pacopacomama 特有格式
