...
namespace JavScraper.Common.Test.Scrapers
{
    ...
    /// Jav123Scraper 单元测试类
    /// </summary>
    public class Jav123ScraperTests : TestBase
    {
        private readonly ITestOutputHelper _output;
        private readonly Jav123Scraper _scraper;

        public Jav123ScraperTests(ITestOutputHelper output)
        {
            _output = output;
            _scraper = (Jav123Scraper)CreateScraper("jav123");
        }

        [Fact]
        public void Name_Should_BeJav123()
        {
            Assert.Equal("jav123", _scraper.Name, ignoreCase: true);
        }
        ...
        public void DefaultBaseUrl_Should_NotBeEmpty()
        {
            ...
            Assert.Contains("jav123", _scraper.DefaultBaseUrl, StringComparison.OrdinalIgnoreCase);
        }
